...
2. Crea una rama: `git checkout -b feature/972-add-content`
3. Agrega tu contenido en el ciclo correspondiente
4. Commit: `git commit -m "feat(972): agregar [descripción]"`
...
**Ruta:** [Área de Computación](../) → [972] Inteligencia Artificial 1
