...
2. Crea una rama: `git checkout -b feature/975-add-content`
3. Agrega tu contenido en el ciclo correspondiente
4. Commit: `git commit -m "feat(975): agregar [descripción]"`
...
**Ruta:** [Área de Computación](../) → [975] Redes de Computadoras 2
