# [964] Organización Computacional
...
2. Crea una rama: `git checkout -b feature/964-add-content`
3. Agrega tu contenido en el ciclo correspondiente
4. Commit: `git commit -m "feat(964): agregar [descripción]"`
...
**Ruta:** [Área de Computación](../) → [964] Organización Computacional
