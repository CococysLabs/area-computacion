...
2. Crea una rama: `git checkout -b feature/777-add-content`
3. Agrega tu contenido en el ciclo correspondiente
4. Commit: `git commit -m "feat(777): agregar [descripción]"`
...
**Ruta:** [Área de Computación](../) → [777] Organización de Lenguajes y Compiladores 1
