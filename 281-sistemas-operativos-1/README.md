...
2. Crea una rama: `git checkout -b feature/281-add-content`
3. Agrega tu contenido en el ciclo correspondiente
4. Commit: `git commit -m "feat(281): agregar [descripción]"`
...
**Ruta:** [Área de Computación](../) → [281] Sistemas Operativos 1
