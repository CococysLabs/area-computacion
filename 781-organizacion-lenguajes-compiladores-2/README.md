...
2. Crea una rama: `git checkout -b feature/781-add-content`
3. Agrega tu contenido en el ciclo correspondiente
4. Commit: `git commit -m "feat(781): agregar [descripción]"`
...
**Ruta:** [Área de Computación](../) → [781] Organización de Lenguajes y Compiladores 2
