...
2. Crea una rama: `git checkout -b feature/970-add-content`
3. Agrega tu contenido en el ciclo correspondiente
4. Commit: `git commit -m "feat(970): agregar [descripción]"`
...
**Ruta:** [Área de Computación](../) → [970] Redes de Computadoras 1
