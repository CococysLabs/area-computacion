# [779] Arquitectura de Computadoras y Ensambladores 2
...
2. Crea una rama: `git checkout -b feature/779-add-content`
3. Agrega tu contenido en el ciclo correspondiente
4. Commit: `git commit -m "feat(779): agregar [descripción]"`
...
**Ruta:** [Área de Computación](../) → [779] Arquitectura de Computadoras y Ensambladores 2
