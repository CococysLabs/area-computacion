# [778] Arquitectura de Computadoras y Ensambladores 1
...
2. Crea una rama: `git checkout -b feature/778-add-content`
3. Agrega tu contenido en el ciclo correspondiente
4. Commit: `git commit -m "feat(778): agregar [descripción]"`
...
**Ruta:** [Área de Computación](../) → [778] Arquitectura de Computadoras y Ensambladores 1
